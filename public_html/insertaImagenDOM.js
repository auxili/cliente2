function inspeccion(articulo) {
    ...
    sst = document.getElementById(articulo.id);
    alert("articulo: " + articulo.id);
    sstPrecio = sst.getElementsByTagName("p");
    ...
    txtPrecio = document.createTextNode("precio: " + sstPrecio);
    txtUnidades = document.createTextNode("Unidades: ");
